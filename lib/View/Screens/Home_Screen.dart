...
Navigator.push(context, MaterialPageRoute(builder: (context)=>UiComponents()));
          ...
          ElevatedButton(onPressed: (){}, child: Text("Primary Order",style: TextStyle(fontSize: 25,)),
             ...
             if(dealerInfo == null)
             ...
             else
               {
                 var exampleArgument = 'example string';
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>Dealers(dealersInfo:dealerInfo ,)));
                 // Navigator.pushNamed(
                 //   context,
                 //   '/otherscreen',
